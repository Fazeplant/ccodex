...
function record(threadId: string): ClaudeThreadRecord {
  const thread: Thread = {
    ...
    canAcceptDirectInput: true, preview: "", ephemeral: false, section: null, sectionEnteredAt: null, projectId: null, environments: null, originator: null, daybreakEnabled: null, historyMode: "legacy",
