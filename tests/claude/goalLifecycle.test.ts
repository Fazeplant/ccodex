  ...
  it("persists goal identity and rejects stale usage after replacement", () => {
    ...
    store.createThread({
      thread: {
        ...
        preview: "", ephemeral: false, section: null, sectionEnteredAt: null, projectId: null, environments: null, originator: null, daybreakEnabled: null, historyMode: "legacy", modelProvider: "claude", model: null, reasoningEffort: null, createdAt: now,
