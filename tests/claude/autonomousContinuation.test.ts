  ...
  it("reconciles a gateway restart as one failed original turn, never success or revival", async () => {
    ...
    const record: ClaudeThreadRecord = {
      thread: {
        ...
        preview: "restart fence", ephemeral: false, section: null, sectionEnteredAt: null, environments: null, originator: null, daybreakEnabled: null, projectId: null, historyMode: "legacy",
