...
function response(id = "public-side"): ThreadForkResponse {
  return {
    thread: {
      ...
      preview: "", ephemeral: true, section: null, sectionEnteredAt: null, projectId: null, environments: null, originator: null, daybreakEnabled: null, historyMode: "legacy", modelProvider: "claude", model: null, reasoningEffort: null,
