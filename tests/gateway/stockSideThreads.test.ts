...
function thread(id: string, threadSource: string | null = STOCK_SIDE_THREAD_SOURCE): Thread {
  return {
    ...
    preview: "side", ephemeral: false, section: null, sectionEnteredAt: null, projectId: null, environments: null, originator: null, daybreakEnabled: null, historyMode: "legacy", modelProvider: "openai", model: null, reasoningEffort: null,
