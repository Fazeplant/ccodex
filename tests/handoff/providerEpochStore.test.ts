...
function thread(id: string): Thread {
  return {
    ...
    ephemeral: false, section: null, sectionEnteredAt: null, environments: null, originator: null, daybreakEnabled: null, projectId: null, historyMode: "legacy", modelProvider: "openai", model: null, reasoningEffort: null, createdAt: 1, updatedAt: 1,
...
function turn(id: string): Turn {
  return {
    id, items: [{ type: "agentMessage", id: `${id}-item`, text: id, phase: "final_answer", memoryCitation: null, questions: null, delivery: null }],
