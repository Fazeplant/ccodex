...
function thread(id: string, turns: Turn[]): Thread {
  return {
    id, extra: null, preview: "preview", ephemeral: false, section: null, sectionEnteredAt: null, environments: null, originator: null, daybreakEnabled: null, projectId: null, historyMode: "legacy", modelProvider: "openai", model: null, reasoningEffort: null, createdAt: 1,
