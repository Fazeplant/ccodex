...
function turn(id: string, text: string): Turn {
  return {
    id,
    items: [{ type: "agentMessage", id: `${id}-item`, text, phase: null, memoryCitation: null, questions: null, delivery: null }],
...
function thread(id: string, turns: Turn[] = []): Thread {
  return {
    ...
    ephemeral: false, section: null, sectionEnteredAt: null, environments: null, originator: null, daybreakEnabled: null, projectId: null, historyMode: "legacy", modelProvider: "openai", model: null, reasoningEffort: null, createdAt: 1, updatedAt: 1, recencyAt: 1,
