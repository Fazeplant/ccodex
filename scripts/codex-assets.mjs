...
const TRANSPORT_OVERLAYS = {
  ...
  // rust-v0.155.1 (adds DaemonShutdown/connection auth/shutdown modules; result typing unchanged)
  "4e21628f9ec9ee656650cd2b62ef92225725b5ac": RESULT_AS_VALUE_OVERLAY,
};
